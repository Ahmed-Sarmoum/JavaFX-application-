...
import camura.CamuraController;
 ...
 * @author Mido
 */
public class MessagePlatformController implements Initializable {
    ...
    @FXML
    private MaterialDesignIconView imgClick;
    ...
    private void searchMsg(KeyEvent event){
        ...
        ObservableList<String> typeUs = FXCollections.observableArrayList();
                 ...
                 try{
                     ...
                     String sql = "SELECT firstname,lastname,etat,image,id,type FROM utilisateurs WHERE lastname LIKE '"+searchMsg.getText()+"%' OR firstname LIKE '"+searchMsg.getText()+"%' AND id != "+UsersLoginController.id;
            ...
            for (int i = 0; i < count.size(); i++) {
                ...
                msg.getStyleClass().addAll("user-name1");
                        ...
                        while (rs1.next()) {
                            ...
                            while (rs2.next()) {
                                ...
                                if (rs1.getInt(2) == Integer.parseInt(id.getText())) {
                                    ...
                                    if (rs1.getString(1).matches(".*.jpg") || dialog1.matches(".*.png")
...
//                                       
                                    ...
                                    if (dialog1.matches(".*.jpg") || dialog1.matches(".*.png")
                                        ...
                                        //لعرض المحتوى ان كان صورة
                                        imageSendedd.setOnMouseClicked((even) -> {
...
//                                       
    ...
    private void callVideo() {
        ...
        try {
            CamuraController.typeOpen = 1;
            capturePane = FXMLLoader.load(getClass().getResource("/camura/camura.fxml"));
            captureChooser = new JFXDialog(message, capturePane, JFXDialog.DialogTransition.TOP);

        } catch (IOException ex) {
            Logger.getLogger(CamuraController.class.getName()).log(Level.SEVERE, null, ex);
        }
        captureChooser.show();
        captureChooser.setOnDialogClosed(e -> {
            if (CamuraController.webcam.isOpen()) {
                CamuraController.webcam.close();
            }
    ...
    public void cameraChooser() {
        ...
        captureChooser.show();
        captureChooser.setOnDialogClosed(e -> {
            CamuraController.isCapture = true;
            if (CamuraController.webcam.isOpen()) {
                CamuraController.webcam.close();
            }

            if (CamuraController.imageSended != null) {
                sendImage(CamuraController.imageSended);
            }
        });
    }
    ...
    @FXML
    void insertMsg(MouseEvent event) {
